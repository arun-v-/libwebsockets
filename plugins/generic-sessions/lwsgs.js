...
var lwsgs_html = '       <div id="dlogin" style="display:none"> \
	 ...
	 <table style="vertical-align:top;text-align:left;display: block;"\
          <tr>\
           <td>User Name</br>\
	   ...
	   <td><input type="submit" id="login" name="login" value="Login" style="margin: 8px; padding: 4px; font-weight=bold;">\
...
function lwsgs_update()
{
	...
	if (lwsgs_user === "")
		...
		document.getElementById("dlogout").style.display = "block";
 }
...
function lwsgs_open_registration()
{
	...
	document.getElementById("dregister").style.display = "block";
}
...
function lwsgs_rupdate()
{
	...
	if (en_forgot)
		document.getElementById('rforgot').style.display = "block";
	else
...
function lwsgs_cupdate()
{
	...
	if (lwsgs_auth & 8) {
		...
		document.getElementById('ccurpw').style.display = "block";
		document.getElementById('ccurpw_name').style.display = "block";
	}
	...
	if (lwsgs_auth & 8) {
		...
		document.getElementById('cemail_name').style.display = "block";
		if (lwsgs_email_check === '0'  &&
	...
	if (en_forgot)
		document.getElementById('cforgot').style.display = "block";
	else
